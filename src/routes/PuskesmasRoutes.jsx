  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <PrivateRoute
            element={<PageProfilePuskesmas />}
            requiredRole="Puskesmas"
          />
        }
      />
      <Route
      ...
      {/* daftar */}
      <Route
        path="/daftar-balita-puskesmas"
        element={
          <PrivateRoute
            element={<PageDaftarBalitaPuskesmas />}
            requiredRole="Puskesmas"
          />
        }
      />
      <Route
        path="/daftar-balita-semua"
        element={
          <PrivateRoute
            element={<PageDaftarBalitaSemuaPuskesmas />}
            requiredRole="Puskesmas"
          />
        }
      />
      <Route
        path="/daftar-balita-posyandu"
        element={
          <PrivateRoute
            element={<PageDaftarPosyanduPuskesmas />}
            requiredRole="Puskesmas"
          />
        }
      />
      ...
      <Route
        ...
        element={
          <PrivateRoute
            element={<PageDetailBalitaPuskesmas />}
            requiredRole="Puskesmas"
          />
        }
      />
      <Route
        path="/edit-data-balita/:idBalita"
        element={
          <PrivateRoute
            element={<PageEditBalitaPuskesmas />}
            requiredRole="Puskesmas"
          />
        }
      />
      <Route
        path="/edit-data-tambahan-balita/:idBalita"
        element={
          <PrivateRoute
            element={<PageEditDataTambahanPuskesmas />}
            requiredRole="Puskesmas"
          />
        }
      />
      <Route
        ...
        element={
          <PrivateRoute
            element={<PageEditPengukuranPuskesmas />}
            requiredRole="Puskesmas"
          />
        }
      />
      <Route
        ...
        element={
          <PrivateRoute
            element={<PageAddPengukuranSelectedPuskesmas />}
            requiredRole="Puskesmas"
          />
        }
      />
      ...
      <Route
        ...
        element={
          <PrivateRoute
            element={<PageDetailPosyanduPuskesmas />}
            requiredRole="Puskesmas"
          />
        }
      />
