      ...
      <nav className="navbar navbar-expand-lg p-0" style={{ backgroundColor: "#026670" }}>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <a
                className="nav-link active mx-3 text-light"
                aria-current="page"
                href="#"
              >
                Beranda
            ...
            <li className="nav-item dropdown">
              <a
                className="nav-link dropdown-toggle mx-3 text-light"
                href="#"
                role="button"
              ...
              <ul className="dropdown-menu">
                <li>
                  <a className="dropdown-item" href="/pencegahan/stunting">
                    Stunting
                  </a>
                </li>
                <li>
                  <a className="dropdown-item" href="/pencegahan/underweight">
                    Underweight
                  </a>
                </li>
                <li>
                  <a className="dropdown-item" href="/pencegahan/wasting">
                    Wasting
                  </a>
                </li>
              </ul>
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                <li>
                  <a className="dropdown-item" href="/pengukuran/stunting">
                    Stunting
                  </a>
                </li>
                <li>
                  <a className="dropdown-item" href="/pengukuran/underweight">
                    Underweight
                  </a>
                </li>
                <li>
                  <a className="dropdown-item" href="/pengukuran/wasting">
                    Wasting
                  </a>
                </li>
              </ul>
