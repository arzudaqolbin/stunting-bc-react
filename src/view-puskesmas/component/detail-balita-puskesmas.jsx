              ...
              <div className="accordion mb-3" id="accordionExample">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      <Link to={`/puskesmas/edit-data-balita/${idBalita}`} className='btn btn-primary'>Edit Data Balita</Link>
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      <div>
                        ...
                        <Link to={`/puskesmas/tambah-data-tambahan/${idBalita}`} className='btn btn-primary'>Tambah Data Tambahan</Link>
                      </div>
                      ...
                      <Link to={`/puskesmas/tambah-data-tambahan/${idBalita}`} className='btn btn-primary'>Edit Data Tambahan</Link>
                      </div>
                      }
                    </div>
                  </div>
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        ...
                        <TabelPengukuranBalitaPuskesmas apiAuth={apiAuth} idBalita={idBalita}/>
                    </div>
                </div>
                <div className="accordion-item">
                    <h2 className="accordion-header">
                        <button className="accordion-button collapsed fw-bold fs-5" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                        Grafik Stunting
                        </button>
                    </h2>
...
export default DetailBalitaPuskesmas;
