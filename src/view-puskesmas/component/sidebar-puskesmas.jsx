      ...
      >
        <div className="h-100">
          ...
          <ul className="sidebar-nav">
            <li class="sidebar-header">Elemen Dashboard Stunting</li>
            ...
            <li class="sidebar-item">
              <a
                href="#"
                class="sidebar-link collapsed border-top"
              ...
              >
                <li class="sidebar-item">
                  <Link
                    to={`/puskesmas/daftar-balita-semua`}
                    class="sidebar-link "
                  >
                    Semua Balita
                  </Link>
                ...
                <li class="sidebar-item">
                  <Link
                    to={`/puskesmas/daftar-balita-puskesmas`}
                    class="sidebar-link"
                  >
                    Balita Puskesmas
                  </Link>
            ...
            <li class="sidebar-item">
              <Link
                to={`/puskesmas/daftar-posyandu`}
                class="sidebar-link border-bottom border-top"
              >
            ...
            <li class="sidebar-item">
              <Link
                ...
                className="sidebar-link border-bottom"
      ...
      >
        ...
        >
          ...
          <div className="d-flex align-items-center navbar-title">
            <p
              className="mb-0 font-weight-bold text-light"
            ...
            <ul className="navbar-nav">
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu dropdown-menu-end">
                  <Link to={`/puskesmas/profile`} className="dropdown-item">
                    Profile
                  </Link>
