  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`http://127.0.0.1:8000/api/beritas`, formData, {
        headers: {
          Authorization:
            "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..pqQjgWhNiK_xu1QxzfBuzPoTi08SuG_a7PH9iH0j_YA",
